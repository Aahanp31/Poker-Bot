...
# This function encodes the current game state into an 85-element float32 feature vector.
# Parameters:
#   - player: the Player whose perspective to encode
#   - gamestate: current Gamestate
#   - use_mc: if True and board cards exist, compute equity via Monte Carlo instead of preflop table
#   - mc_sims: number of MC simulations when use_mc is True
# Returns:
#   - np.ndarray: shape (85,), dtype float32, all values normalized to [0, 1]
#
# Vector layout:
